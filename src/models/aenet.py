"""
AENet model implementation from CelebA-Spoof dataset.
"""
...
class AENet(nn.Module):
    ...
    def __init__(self, block=BasicBlock, layers=[2, 2, 2, 2], num_classes=2, sync_stats=False):
        global BN
        ...
        self.fc_live = nn.Linear(512 * block.expansion, num_classes)
